/**
 * Created by Adekunle Adeyemi on 22/01/2016.
 */
(function (window, angular) {
    ...
    angular
        ...
        .factory('loginSvc', [
            '$http', '$rootScope', '$q', 'userCacheSvc',
            function($http, $rootScope, $q, userCacheSvc) {
                ...
                // secured endpoint
                var LOGIN_URL = '/api/access/login'; // old: '/api/login'
                ...
                function autoLogin() {
                    // start with no authentication tokens
